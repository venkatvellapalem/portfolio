    ...
    <section className="relative overflow-hidden">
      ...
      <div className="shell relative flex min-h-[78vh] flex-col justify-center py-24">
        ...
        <h1 className="reveal mt-6 max-w-5xl text-[clamp(2.75rem,7vw,5.75rem)] font-semibold leading-[0.98] tracking-tightest">
          ...
          <span className="text-fg-muted">engineered for the next decade.</span>
        </h1>

        <p className="reveal mt-8 max-w-2xl text-lg leading-relaxed text-fg-muted">
          I’m Venkat — a security researcher and technical founder building tools,
          writing about offensive and defensive systems, and shipping products
          that take privacy seriously.
        </p>

        <div className="reveal mt-10 flex flex-wrap items-center gap-4">
          <GlowButton href="/projects">View projects</GlowButton>
          <Link href="/blogs" className="nav-link text-sm">Read the blog →</Link>
        </div>
...
// In app/page.tsx:
//
// import { Hero } from "./_hero"; // or inline this component
// export default function Home() {
//   return (
//     <>
//       <Hero />
//       <SectionWrapper title="Featured projects" eyebrow="// work">
//         {/* existing project grid */}
//       </SectionWrapper>
//       <SectionWrapper title="Latest writing" eyebrow="// blog">
//         {/* existing blog list */}
//       </SectionWrapper>
//     </>
//   );
